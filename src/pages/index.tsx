  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction tool rental v1 - Streamlining the process of renting construction tools from multiple outlets, making it easier for individual customers."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction tool rental v1 - Streamlining the process of renting construction tools from multiple outlets, making it easier for individual customers.`}
            </Text>
            <Box
