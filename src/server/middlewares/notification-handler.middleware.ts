...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order.create.create': { roles: ['tenant-owner', 'tenant-admin'], key: 'order', tenantPath: [], userPath: [] },
  'pricing.update.update': { roles: ['tenant-owner', 'tenant-admin'], key: 'pricing', tenantPath: [], userPath: [] },
  'product.create.create': { roles: ['tenant-owner', 'tenant-admin'], key: 'product', tenantPath: [], userPath: [] },
};
